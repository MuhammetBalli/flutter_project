...
class _TopRatedTvShowsState extends State<TopRatedTvShows> {
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels >=
        ...
        !tvShowProvider.isTopRatedTvShowLoading) {
      tvShowProvider.fetchTopRatedTvShows();
    }
  }
    ...
    return Scaffold(
      body: Consumer<TvShowProvider>(
        builder: (context, tvShowProvider, child) {
          if (tvShowProvider.isTopRatedTvShowLoading &&
              tvShowProvider.tvShowsTopRated.isEmpty) {
            return const Center(child: CircularProgressIndicator());
          } else if (tvShowProvider.tvShowsTopRated.isEmpty) {
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: tvShowProvider.tvShowsTopRated.length +
                        (tvShowProvider.isTopRatedTvShowLoading ? 1 : 0),
                    itemBuilder: (context, index) {
                      if (index == tvShowProvider.tvShowsTopRated.length) {
                        return const Center(child: CircularProgressIndicator());
                      }
                      final tvShow = tvShowProvider.tvShowsTopRated[index];
